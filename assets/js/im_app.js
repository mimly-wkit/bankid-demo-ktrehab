...
function joinSession() {
    ...
    if(webComponent.getAttribute("openvidu-secret") != undefined && webComponent.getAttribute("openvidu-server-url") != undefined ){
        ...
        if(tokens)
        {
            setTimeout(function(){ updateCurrUsers(); }, 10000);
        }
        // setTimeout(function(){ updateCurrUsers(); }, 5000);
    }
}
...
function createSession(sessionName)
{
    return new Promise((resolve) => {
        $.ajax({
            type: 'POST',
            url: BEHANDLARE_URL+'immediateconference/get_session/1',
...
function createToken(sessionId)
{
    ...
    return new Promise((resolve) => {
        $.ajax({
            type: 'POST',
            url: BEHANDLARE_URL + 'immediateconference/get_tokens/1',
            data: {  sess : sessionId  },
...
function updateCurrUsers()
{
    ...
    $.post(BEHANDLARE_URL+'immediateconference/update_session_user/',{sess:sessionName,p:pid},function(resp){
