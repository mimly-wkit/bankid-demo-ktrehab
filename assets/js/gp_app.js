...
function createSession(sessionName)
{
    return new Promise((resolve) => {
        $.ajax({
            type: 'POST',
            url: BEHANDLARE_URL+'gconferenece/get_session/1',
...
function createToken(sessionId)
{
    ...
    return new Promise((resolve) => {
        ...
        $.ajax({
            type: 'POST',
            url: BEHANDLARE_URL + 'gconferenece/get_tokens/1',
            data: {  sess : sessionId , usertoken:usertoken },
...
{
    return new Promise((resolve)=>{
        $.post(BEHANDLARE_URL+'gconferenece/check_leave_status/'+sessionName,function(resp){
            resolve(resp)
        })
    });
}
